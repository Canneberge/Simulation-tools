...
class BDF_3(Explicit_ODE):
    ...
    def integrate(self, t, y, tf, opts):
        ...
        for i in range(self.maxsteps):
            ...
            if i == 0:  # initial step
                ...
                t_np1, y_np1 = self.step_BDF3([t, t_nm1, t_nm2],
                                              [y, y_nm1, y_nm2],
                                              h)
                t, t_nm1, t_nm2 = t_np1, t, t_nm1
                y, y_nm1, y_nm2 = y_np1, y, y_nm1
            ...
            msg = "Final time not reached within maximum number of steps"
            raise Explicit_ODE_Exception(msg)
    ...
    def step_BDF2(self, T, Y, h):
        ...
        for i in range(self.maxit):
            ...
            msg = "Corrector could not converge within % iterations" % i
            raise Explicit_ODE_Exception(msg)
